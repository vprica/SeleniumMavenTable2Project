...
public class TablePage {
    ...
    public WebElement getTable(){
        return this.driver.findElement(By.xpath(".//table[@id='table2']"));
    }
    ...
    public List<HashMap<String, String>> getTableData(String excludedColumn){
        ...
        for (int i = 0; i < headerList.size(); i++){
            header.add(headerList.get(i).findElement(By.xpath(".//span")).getText());
        }
    ...
    public String getCallData(String columnName, int rowIndex){
